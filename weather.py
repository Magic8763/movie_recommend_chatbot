...
json_api = {"宜蘭縣":"F-D0047-001","桃園市":"F-D0047-005","新竹縣":"F-D0047-009","苗栗縣":"F-D0047-013",
            ...
            "連江縣":"F-D0047-081","金門縣":"F-D0047-085"} # 將主要縣市個別的 JSON 代碼列出

# 本地天氣狀況
def Get_Weather(address):
    city_list, area_list = {}, {} # 定義好待會要用的變數
...
def Get_Forecast(address):
    try:
        ...
        try:
            url = f'https://opendata.cwa.gov.tw/api/v1/rest/datastore/{json_api[i]}?Authorization={AuthorizationCode}&elementName=WeatherDescription'
